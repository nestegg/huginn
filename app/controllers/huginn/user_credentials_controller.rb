module Huginn
  class UserCredentialsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @user_credential.save
          format.html { redirect_to huginn_user_credentials_path, notice: 'Your credential was successfully created.' }
    ...
    def update
      ...
      respond_to do |format|
        if @user_credential.update_attributes(params[:user_credential])
          format.html { redirect_to huginn_user_credentials_path, notice: 'Your credential was successfully updated.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to huginn_user_credentials_path }
        format.json { head :no_content }
      end
    end
  end
