module Huginn::Agents
  class LocalFileAgent < Huginn::Agent
    include Huginn::LongRunnable
    include Huginn::FormConfigurable
    include Huginn::FileHandling
    ...
    description do
      <<-MD
        ...
        *Warning*: This type of Agent can read and write any file the user that runs the Huginn server has access to, and is #{Huginn::Agents::LocalFileAgent.should_run? ? "**currently enabled**" : "**currently disabled**"}.
