...
module Huginn::Agents
  class WebsiteAgent < Huginn::Agent
    include Huginn::WebRequestConcern
    ...
    class ResponseDrop < Huginn::LiquidDroppable::Drop
      def headers
    ...
    class HeaderDrop < Huginn::LiquidDroppable::Drop
