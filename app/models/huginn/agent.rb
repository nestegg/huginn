...
module Huginn
  class Agent < ActiveRecord::Base
    ...
    class << self
      ...
      def can_control_other_agents?
        include? Huginn::AgentControllerConcern
      end
      ...
      def async_receive(agent_id, event_ids)
        Huginn::AgentReceiveJob.perform_later(agent_id, event_ids)
      end
      ...
      def async_check(agent_id)
        Huginn::AgentCheckJob.perform_later(agent_id)
      end
    end
  end
