...
module Huginn::LiquidInterpolatable
  ...
  Liquid::Template.register_filter(Huginn::LiquidInterpolatable::Filters)
  ...
  Liquid::Template.register_tag('credential', Huginn::LiquidInterpolatable::Tags::Credential)
  Liquid::Template.register_tag('line_break', Huginn::LiquidInterpolatable::Tags::LineBreak)
  ...
  Liquid::Template.register_tag('regex_replace',       Huginn::LiquidInterpolatable::Blocks::RegexReplace)
  Liquid::Template.register_tag('regex_replace_first', Huginn::LiquidInterpolatable::Blocks::RegexReplace)
end
