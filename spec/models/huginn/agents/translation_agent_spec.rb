...
describe Huginn::Agents::TranslationAgent do
    before do
        @valid_params = {
            :name    => "somename",
            :options => {
        ...
        @checker = Huginn::Agents::TranslationAgent.new(@valid_params)
    ...
    describe "#working?" do
        it "checks if events have been received within expected receive period" do
            ...
            Huginn::Agents::TranslationAgent.async_receive @checker.id, [@event.id]
