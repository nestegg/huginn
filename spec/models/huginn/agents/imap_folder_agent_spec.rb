...
describe Huginn::Agents::ImapFolderAgent do
  describe 'checking IMAP' do
    before do
      ...
      @checker = Huginn::Agents::ImapFolderAgent.new(:name => 'Example', :options => @site, :keep_events_for => 2.days)
      ...
      message_mixin = Module.new {
        ...
        def body_parts(mime_types = %[text/plain text/enriched text/html])
          mime_types.map { |type|
            ...
            part.extend(Huginn::Agents::ImapFolderAgent::Message::Scrubbed)
          }
        end

        include Huginn::Agents::ImapFolderAgent::Message::Scrubbed
      }
    ...
    describe '#check' do
      it 'should check for mails and save memory' do
        ...
        Huginn::Event.last(2).map(&:payload) == @payloads
      ...
      it 'should narrow mails by To' do
        ...
        expect(Huginn::Event.last.payload).to eq(@payloads.first)
      ...
      it 'should perform regexp matching and save named captures' do
        ...
        expect(Huginn::Event.last.payload).to eq(@payloads.last.update(
      ...
      it 'should narrow mails by has_attachment (true)' do
        ...
        expect(Huginn::Event.last.payload['subject']).to eq('Re: some subject')
      end
      ...
      it 'should narrow mails by has_attachment (false)' do
        ...
        expect(Huginn::Event.last.payload['subject']).to eq('some subject')
      end
  ...
  describe 'Huginn::Agents::ImapFolderAgent::Message::Scrubbed' do
    before do
      @class = Class.new do
        def subject
