...
describe Huginn::Agents::StubhubAgent do
  ...
  describe "#check" do
    ...
    it 'should create an event' do
      expect { @stubhub_agent.check }.to change { Huginn::Event.count }.by(1)
    end
  ...
  describe "#working?" do
    it "checks if events have been received within the expected receive period" do
      ...
      Huginn::Agents::StubhubAgent.async_check @stubhub_agent.id
