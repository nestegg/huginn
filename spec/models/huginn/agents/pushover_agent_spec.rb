...
describe Huginn::Agents::PushoverAgent do
  before do
    @checker = Huginn::Agents::PushoverAgent.new(:name => 'Some Name',
                                       :options => { :token => 'x',
                                                :user => 'x',
    ...
    @sent_notifications = []
    stub.any_instance_of(Huginn::Agents::PushoverAgent).send_notification  { |notification| @sent_notifications << notification}
  end
  ...
  describe '#working?' do
    it 'checks if events have been received within the expected receive period' do
      ...
      Huginn::Agents::PushoverAgent.async_receive @checker.id, [@event.id]
