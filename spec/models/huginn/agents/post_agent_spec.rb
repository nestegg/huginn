...
describe Huginn::Agents::PostAgent do
  before do
    @valid_options = {
    ...
    @checker = Huginn::Agents::PostAgent.new(@valid_params)
    ...
    stub_request(:any, /:/).to_return { |request|
      ...
      when :get, :delete
        ...
        when Huginn::Agents::PostAgent::MIME_RE
          req.data = request.body
        else
  ...
  describe "#working?" do
    it "checks if events have been received within expected receive period" do
      ...
      Huginn::Agents::PostAgent.async_receive @checker.id, [@event.id]
