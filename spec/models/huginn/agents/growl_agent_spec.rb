...
describe Huginn::Agents::GrowlAgent do
  before do
    @checker = Huginn::Agents::GrowlAgent.new(:name => 'a growl agent',
  ...
  describe "#working?" do
    it "checks if events have been received within the expected receive period" do
      ...
      Huginn::Agents::GrowlAgent.async_receive @checker.id, [@event.id]
  ...
  describe "receive" do
    ...
    it "should not call notify_growl if message or subject are missing" do
      event_without_a_subject = Huginn::Event.new
      event_without_a_subject.agent = huginn_agents(:bob_weather_agent)
      event_without_a_subject.payload = { :message => 'Looks like its going to rain' }
      event_without_a_subject.save!

      event_without_a_message = Huginn::Event.new
      event_without_a_message.agent = huginn_agents(:bob_weather_agent)
