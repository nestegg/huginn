...
describe Huginn::Agents::TwitterUserAgent do
  before do
    ...
    @checker = Huginn::Agents::TwitterUserAgent.new(:name => "tectonic", :options => @opts)
  ...
  describe "#check" do
    it "should check for changes" do
      expect { @checker.check }.to change { Huginn::Event.count }.by(5)
    end
  end
