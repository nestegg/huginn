...
describe Huginn::LiquidInterpolatable::Filters do
  before do
    @filter = Class.new do
      include Huginn::LiquidInterpolatable::Filters
    end.new
  end
  ...
  describe 'validations' do
    class Huginn::Agents::InterpolatableAgent < Huginn::Agent
      include Huginn::LiquidInterpolatable
    ...
    it "should finish without raising an exception" do
      agent = Huginn::Agents::InterpolatableAgent.new(name: "test", options: { 'foo' => '{{bar}' })
  ...
  describe 'unescape' do
    let(:agent) { Huginn::Agents::InterpolatableAgent.new(name: "test") }
  ...
  describe 'to_uri' do
    before do
      @agent = Huginn::Agents::InterpolatableAgent.new(name: "test", options: { 'foo' => '{% assign u = s | to_uri %}{{ u.path }}' })
  ...
  describe 'uri_expand' do
    ...
    describe 'used in interpolation' do
      before do
        @agent = Huginn::Agents::InterpolatableAgent.new(name: "test")
      end
