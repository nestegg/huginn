...
This branch pushes most everything Huginn specific into a Huginn module in order to create a Huginn namespace in preparation for pulling it out into an engine.  Currently all test are passing.
